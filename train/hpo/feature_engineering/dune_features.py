...
def load_dune_raw_data(symbol: str) -> pd.DataFrame:
    ...
    for f in files:
        try:
            ...
            if 'day' in df.columns:
                ...
                df['timestamp'] = df['timestamp'].astype(str).str.replace(' Asia/Seoul', '', regex=False)
    ...
    required_cols = ["eth_to_cex", "whale_to_cex", "eth_from_cex", "cex_to_whale", "deposit_amount", "withdraw_amount"]
